...
import { deleteAdminPost, deleteStudentPost } from "../api";
// taken from https://react-bootstrap.github.io/components/modal/
function ConfirmAdminPostDelete({ props, setError, setSuccess }) {
  ...
  async function handleDelete() {
    ...
    setError("");
    setSuccess("");
    const result = await deleteAdminPost({ postID: props._id });
    if (result.error) {
...
export default ConfirmAdminPostDelete;
